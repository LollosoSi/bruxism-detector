...
public class StatData {
	...
	static String produce_csv_header () {
		return "Date;Duration;Clenching Rate (per hour);Jaw Events;Alarm Triggers;Beep Count;Button Presses;Stopped after beep;Did not stop after beeps;Avg beeps per event;Alarm %;Average clenching event pause (minutes);Average clenching duration (seconds);Workout;Hydrated;Stressed;Caffeine;Anxious;Alcohol;Bad meal;Medications;Day pain;Life event";
	}
